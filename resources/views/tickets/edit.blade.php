            ...
            <div class="bg-white shadow rounded p-6">
                <form method="POST" action="{{ route('tickets.update', $ticket) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" class="w-full border rounded p-2" value="{{ old('title', $ticket->title) }}">
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium">Description</label>
                        <textarea name="description" class="w-full border rounded p-2" rows="5">{{ old('description', $ticket->description) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="resolution_notes" class="w-full border rounded p-2" rows="4">{{ old('resolution_notes', $ticket->resolution_notes) }}</textarea>
                    </div>
